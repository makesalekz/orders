...
func (_u *OrderUpdate) SetCounterpartyID(v int64) *OrderUpdate {
...
func (_u *OrderUpdate) SetNillableCounterpartyID(v *int64) *OrderUpdate {
	if v != nil {
...
func (_u *OrderUpdate) AddCounterpartyID(v int64) *OrderUpdate {
...
func (_u *OrderUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.AddedCounterpartyID(); ok {
		_spec.AddField(order.FieldCounterpartyID, field.TypeInt64, value)
	}
...
// SetCounterpartyID sets the "counterparty_id" field.
func (_u *OrderUpdateOne) SetCounterpartyID(v int64) *OrderUpdateOne {
	_u.mutation.ResetCounterpartyID()
	_u.mutation.SetCounterpartyID(v)
	return _u
}
...
// SetNillableCounterpartyID sets the "counterparty_id" field if the given value is not nil.
func (_u *OrderUpdateOne) SetNillableCounterpartyID(v *int64) *OrderUpdateOne {
	if v != nil {
		_u.SetCounterpartyID(*v)
	}
	return _u
...
// AddCounterpartyID adds value to the "counterparty_id" field.
func (_u *OrderUpdateOne) AddCounterpartyID(v int64) *OrderUpdateOne {
	_u.mutation.AddCounterpartyID(v)
	return _u
}
